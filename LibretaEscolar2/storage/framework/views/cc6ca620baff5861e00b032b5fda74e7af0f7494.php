    ...
    <section class="admin">
        <div class="container">
            <div class="user signinBx">
                ...
                <div class="formBx"> 
                    <form action="<?php echo e(route('auth.check_admin')); ?>" method="POST">
...
</html><?php /**PATH D:\Aplicaciones\laragon\www\LibretaEscolar\resources\views/auth/loginadmin.blade.php ENDPATH**/ ?>
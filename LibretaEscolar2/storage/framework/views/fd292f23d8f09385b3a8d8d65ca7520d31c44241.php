...
<table>
   ...
   <h1>Reporte de notas</h1>
    ...
    <table>
        <thead>
            ...
            <?php $__currentLoopData = $actividades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $actividad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <th> Tarea: <?php echo e($actividad->titulo); ?></th>
    ...
    <br>
    <a href="<?php echo e(route('reporte.generate.docente', [$curso])); ?>">Descargar reporte de notas</a>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.plantilla', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Aplicaciones\laragon\www\LibretaEscolar\resources\views/reporte/show_docente.blade.php ENDPATH**/ ?>
    ...
    <section class="docente">
        <div class="container">
            <div class="user signinBx">
                ...
                <div class="formBx"> 
                    <form action="<?php echo e(route('auth.check_docente')); ?>" method="POST">   <!--Formulario de inicio de sesion-->
...
</html><?php /**PATH C:\laragon\www\LibretaEscolar2\resources\views/auth/logindocente.blade.php ENDPATH**/ ?>